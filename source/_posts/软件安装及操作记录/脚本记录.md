...
### 3、MySQL [数据库备份](https://so.csdn.net/so/search?q=数据库备份&spm=1001.2101.3001.7020)单循环
...
### 6、Nginx 访问[日志分析](https://so.csdn.net/so/search?q=日志分析&spm=1001.2101.3001.7020)脚本
